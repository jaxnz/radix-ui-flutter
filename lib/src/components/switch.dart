...
class RadixSwitch extends StatelessWidget {
  ...
  const RadixSwitch({super.key, required this.value, this.onChanged, this.label, this.size = RadixSwitchSize.md});
  ...
  Widget build(BuildContext context) {
    ...
    final sw = Transform.scale(
      scale: _scale,
      child: Switch(value: value, onChanged: onChanged, activeColor: c.accentText, activeTrackColor: c.accent, materialTapTargetSize: MaterialTapTargetSize.shrinkWrap),
    );
